...
def test_get_post():
    ...
    assert "full_body" in r.get("data").get("post").get("primary")
    assert "image" in r.get("data").get("post").get("primary")
    assert "domain_name" in r.get("data").get("post").get("primary")
